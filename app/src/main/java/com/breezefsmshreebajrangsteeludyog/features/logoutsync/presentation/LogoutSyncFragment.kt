package com.breezefsmshreebajrangsteeludyog.features.logoutsync.presentation
...
import com.breezefsmshreebajrangsteeludyog.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmshreebajrangsteeludyog.features.billing.api.AddBillingRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.model.*
...
import com.breezefsmshreebajrangsteeludyog.features.quotation.model.AddQuotInputModel
import com.breezefsmshreebajrangsteeludyog.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefsmshreebajrangsteeludyog.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefsmshreebajrangsteeludyog.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefsmshreebajrangsteeludyog.features.timesheet.model.AddTimeSheetInputModel
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.model.AddOrderInputProductList
...
import com.breezefsmshreebajrangsteeludyog.MonitorService
...
import com.breezefsmshreebajrangsteeludyog.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefsmshreebajrangsteeludyog.features.login.model.GetConcurrentUserResponse
import com.breezefsmshreebajrangsteeludyog.features.login.model.WhatsappApiData
import com.breezefsmshreebajrangsteeludyog.features.performance.model.Gps_status_list
import com.breezefsmshreebajrangsteeludyog.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefsmshreebajrangsteeludyog.features.returnsOrder.ReturnProductList
import com.breezefsmshreebajrangsteeludyog.features.returnsOrder.ReturnRequest
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log.zip").path);
