package com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation
...
import com.breezefsmshreebajrangsteeludyog.*
import com.breezefsmshreebajrangsteeludyog.R
import com.breezefsmshreebajrangsteeludyog.app.*
import com.breezefsmshreebajrangsteeludyog.app.NewFileUtils.browseDocuments
import com.breezefsmshreebajrangsteeludyog.app.NewFileUtils.browsePDFDocuments
import com.breezefsmshreebajrangsteeludyog.app.NewFileUtils.getExtension
import com.breezefsmshreebajrangsteeludyog.app.domain.*
import com.breezefsmshreebajrangsteeludyog.app.types.DashboardType
import com.breezefsmshreebajrangsteeludyog.app.types.FragType
import com.breezefsmshreebajrangsteeludyog.app.types.TopBarConfig
import com.breezefsmshreebajrangsteeludyog.app.uiaction.DisplayAlert
import com.breezefsmshreebajrangsteeludyog.app.utils.*
import com.breezefsmshreebajrangsteeludyog.app.utils.AppUtils.Companion.isProfile
import com.breezefsmshreebajrangsteeludyog.base.BaseResponse
import com.breezefsmshreebajrangsteeludyog.base.presentation.BaseActivity
import com.breezefsmshreebajrangsteeludyog.base.presentation.BaseFragment
import com.breezefsmshreebajrangsteeludyog.features.NewQuotation.*
import com.breezefsmshreebajrangsteeludyog.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmshreebajrangsteeludyog.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmshreebajrangsteeludyog.features.SearchLocation.SearchLocationFragment
import com.breezefsmshreebajrangsteeludyog.features.SearchLocation.locationInfoModel
import com.breezefsmshreebajrangsteeludyog.features.TA.ViewAllTAListFragment
import com.breezefsmshreebajrangsteeludyog.features.achievement.AchievementFragment
import com.breezefsmshreebajrangsteeludyog.features.activities.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.*
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.model.GetReportToResponse
import com.breezefsmshreebajrangsteeludyog.features.addAttendence.model.Leave_list_Response
import com.breezefsmshreebajrangsteeludyog.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmshreebajrangsteeludyog.features.addshop.presentation.AddShopFragment
import com.breezefsmshreebajrangsteeludyog.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmshreebajrangsteeludyog.features.addshop.presentation.ScanImageFragment
import com.breezefsmshreebajrangsteeludyog.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmshreebajrangsteeludyog.features.alarm.model.AlarmData
import com.breezefsmshreebajrangsteeludyog.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmshreebajrangsteeludyog.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmshreebajrangsteeludyog.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.alarm.presetation.VisitReportFragment
import com.breezefsmshreebajrangsteeludyog.features.attendance.AttendanceFragment
import com.breezefsmshreebajrangsteeludyog.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmshreebajrangsteeludyog.features.attendance.model.AttendanceRequest
import com.breezefsmshreebajrangsteeludyog.features.attendance.model.AttendanceResponse
import com.breezefsmshreebajrangsteeludyog.features.averageshop.presentation.AverageShopFragment
import com.breezefsmshreebajrangsteeludyog.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmshreebajrangsteeludyog.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmshreebajrangsteeludyog.features.beatCustom.TeamBeatListFragment
import com.breezefsmshreebajrangsteeludyog.features.billing.presentation.AddBillingFragment
import com.breezefsmshreebajrangsteeludyog.features.billing.presentation.BillingDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.billing.presentation.BillingListFragment
import com.breezefsmshreebajrangsteeludyog.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmshreebajrangsteeludyog.features.chat.model.ChatListDataModel
import com.breezefsmshreebajrangsteeludyog.features.chat.model.ChatUserDataModel
import com.breezefsmshreebajrangsteeludyog.features.chat.model.GroupUserDataModel
import com.breezefsmshreebajrangsteeludyog.features.chat.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.chatbot.presentation.ChatBotFragment
import com.breezefsmshreebajrangsteeludyog.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmshreebajrangsteeludyog.features.chatbot.presentation.ReportsFragment
import com.breezefsmshreebajrangsteeludyog.features.chatbot.presentation.SelectLanguageDialog
import com.breezefsmshreebajrangsteeludyog.features.commondialog.presentation.CommonDialog
import com.breezefsmshreebajrangsteeludyog.features.commondialog.presentation.CommonDialogClickListener
import com.breezefsmshreebajrangsteeludyog.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmshreebajrangsteeludyog.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmshreebajrangsteeludyog.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmshreebajrangsteeludyog.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmshreebajrangsteeludyog.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmshreebajrangsteeludyog.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmshreebajrangsteeludyog.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmshreebajrangsteeludyog.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmshreebajrangsteeludyog.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmshreebajrangsteeludyog.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmshreebajrangsteeludyog.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmshreebajrangsteeludyog.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmshreebajrangsteeludyog.features.document.presentation.DocumentListFragment
import com.breezefsmshreebajrangsteeludyog.features.document.presentation.DocumentTypeListFragment
import com.breezefsmshreebajrangsteeludyog.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmshreebajrangsteeludyog.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmshreebajrangsteeludyog.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmshreebajrangsteeludyog.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmshreebajrangsteeludyog.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmshreebajrangsteeludyog.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmshreebajrangsteeludyog.features.home.presentation.HomeFragment
import com.breezefsmshreebajrangsteeludyog.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmshreebajrangsteeludyog.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmshreebajrangsteeludyog.features.know_your_state.KnowYourStateFragment
import com.breezefsmshreebajrangsteeludyog.features.lead.LeadFrag
import com.breezefsmshreebajrangsteeludyog.features.lead.ViewLeadFrag
import com.breezefsmshreebajrangsteeludyog.features.leaveapplynew.LeaveHome
import com.breezefsmshreebajrangsteeludyog.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmshreebajrangsteeludyog.features.localshops.LocalShopListFragment
import com.breezefsmshreebajrangsteeludyog.features.localshops.LocalShopListMapFragment
import com.breezefsmshreebajrangsteeludyog.features.localshops.NearByShopsMapFragment
import com.breezefsmshreebajrangsteeludyog.features.location.*
import com.breezefsmshreebajrangsteeludyog.features.location.api.LocationRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.location.model.*
import com.breezefsmshreebajrangsteeludyog.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefsmshreebajrangsteeludyog.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefsmshreebajrangsteeludyog.features.login.ShopFeedbackEntity
import com.breezefsmshreebajrangsteeludyog.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmshreebajrangsteeludyog.features.login.presentation.LoginActivity
import com.breezefsmshreebajrangsteeludyog.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmshreebajrangsteeludyog.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmshreebajrangsteeludyog.features.marketAssist.MarketAssistTabFrag
import com.breezefsmshreebajrangsteeludyog.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefsmshreebajrangsteeludyog.features.marketAssist.ShopListMarketAssistFrag
import com.breezefsmshreebajrangsteeludyog.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmshreebajrangsteeludyog.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmshreebajrangsteeludyog.features.member.MapViewForTeamFrag
import com.breezefsmshreebajrangsteeludyog.features.member.model.TeamLocDataModel
import com.breezefsmshreebajrangsteeludyog.features.member.model.TeamShopListDataModel
import com.breezefsmshreebajrangsteeludyog.features.member.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.menuBeat.MenuBeatFrag
import com.breezefsmshreebajrangsteeludyog.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmshreebajrangsteeludyog.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmshreebajrangsteeludyog.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmshreebajrangsteeludyog.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmshreebajrangsteeludyog.features.myjobs.model.CustomerDataModel
import com.breezefsmshreebajrangsteeludyog.features.myjobs.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.myorder.presentation.MyOrderListFragment
import com.breezefsmshreebajrangsteeludyog.features.myprofile.presentation.MyProfileFragment
...
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.model.ShopListResponse
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmshreebajrangsteeludyog.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmshreebajrangsteeludyog.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmshreebajrangsteeludyog.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmshreebajrangsteeludyog.features.newcollection.CollectionShopListFragment
import com.breezefsmshreebajrangsteeludyog.features.newcollection.NewCollectionListFragment
import com.breezefsmshreebajrangsteeludyog.features.newcollectionreport.*
import com.breezefsmshreebajrangsteeludyog.features.notification.NotificationFragment
import com.breezefsmshreebajrangsteeludyog.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmshreebajrangsteeludyog.features.orderList.NewOrderListFragment
import com.breezefsmshreebajrangsteeludyog.features.orderList.OrderListFragment
import com.breezefsmshreebajrangsteeludyog.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.ActivityMapFragment
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.OrderhistoryFragment
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.TimeLineFragment
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefsmshreebajrangsteeludyog.features.orderhistory.model.LocationData
import com.breezefsmshreebajrangsteeludyog.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmshreebajrangsteeludyog.features.performance.GpsStatusFragment
import com.breezefsmshreebajrangsteeludyog.features.performance.PerformanceFragment
import com.breezefsmshreebajrangsteeludyog.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmshreebajrangsteeludyog.features.performanceAPP.OwnPerformanceFragment
import com.breezefsmshreebajrangsteeludyog.features.performanceAPP.PerformanceAppFragment
import com.breezefsmshreebajrangsteeludyog.features.performanceAPP.allPerformanceFrag
import com.breezefsmshreebajrangsteeludyog.features.permissionList.ViewPermissionFragment
import com.breezefsmshreebajrangsteeludyog.features.photoReg.*
import com.breezefsmshreebajrangsteeludyog.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmshreebajrangsteeludyog.features.quotation.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.reimbursement.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.report.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.returnsOrder.*
import com.breezefsmshreebajrangsteeludyog.features.settings.presentation.SettingsFragment
import com.breezefsmshreebajrangsteeludyog.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmshreebajrangsteeludyog.features.shopdetail.presentation.*
import com.breezefsmshreebajrangsteeludyog.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmshreebajrangsteeludyog.features.stock.StockDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.stock.StockListFragment
import com.breezefsmshreebajrangsteeludyog.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmshreebajrangsteeludyog.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmshreebajrangsteeludyog.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefsmshreebajrangsteeludyog.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmshreebajrangsteeludyog.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmshreebajrangsteeludyog.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmshreebajrangsteeludyog.features.survey.SurveyFrag
import com.breezefsmshreebajrangsteeludyog.features.survey.SurveyViewDtlsFrag
import com.breezefsmshreebajrangsteeludyog.features.survey.SurveyViewFrag
import com.breezefsmshreebajrangsteeludyog.features.task.presentation.AddTaskFragment
import com.breezefsmshreebajrangsteeludyog.features.task.presentation.CalenderTaskFragment
import com.breezefsmshreebajrangsteeludyog.features.task.presentation.EditTaskFragment
import com.breezefsmshreebajrangsteeludyog.features.task.presentation.TaskListFragment
import com.breezefsmshreebajrangsteeludyog.features.taskManagement.TaskManagementFrag
import com.breezefsmshreebajrangsteeludyog.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmshreebajrangsteeludyog.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmshreebajrangsteeludyog.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmshreebajrangsteeludyog.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.CartFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.ViewCartFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmshreebajrangsteeludyog.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmshreebajrangsteeludyog.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmshreebajrangsteeludyog.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmshreebajrangsteeludyog.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmshreebajrangsteeludyog.features.viewPPDDStock.ViewStockFragment
import com.breezefsmshreebajrangsteeludyog.features.weather.presentation.WeatherFragment
import com.breezefsmshreebajrangsteeludyog.mappackage.MapActivity
import com.breezefsmshreebajrangsteeludyog.mappackage.MapActivityWithoutPath
import com.breezefsmshreebajrangsteeludyog.mappackage.SendBrod
...
//            Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        println("load_frag " + mFragType.toString() + "     " + Pref.user_id.toString()+" "+Pref.ShowUserwiseLeadMenu )
...
*/
    ...
    fun getNamePhoneDetails(): ArrayList<Contact>? {
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmshreebajrangsteeludyoglogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmshreebajrangsteeludyog/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmshreebajrangsteeludyoglogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
