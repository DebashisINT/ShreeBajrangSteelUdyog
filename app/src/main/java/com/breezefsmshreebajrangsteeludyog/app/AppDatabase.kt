package com.breezefsmshreebajrangsteeludyog.app
...
import com.breezefsmshreebajrangsteeludyog.app.AppConstant.DBNAME
import com.breezefsmshreebajrangsteeludyog.app.domain.*
import com.breezefsmshreebajrangsteeludyog.features.lead.model.LeadActivityDao
import com.breezefsmshreebajrangsteeludyog.features.lead.model.LeadActivityEntity
import com.breezefsmshreebajrangsteeludyog.features.location.UserLocationDataDao
import com.breezefsmshreebajrangsteeludyog.features.location.UserLocationDataEntity
import com.breezefsmshreebajrangsteeludyog.features.login.*
import com.breezefsmshreebajrangsteeludyog.features.taskManagement.model.TaskManagementDao
...
*/
                /* database.execSQL("CREATE TABLE shop_visit_revisit_whatsapp_status (sl_no INTEGER NOT NULL PRIMARY KEY, shop_id TEXT, shop_name TEXT, contactNo TEXT, isNewShop INTEGER DEFAULT 0, " +
                         "date TEXT, time TEXT,isWhatsappSent INTEGER NOT NULL DEFAULT 0,whatsappSentMsg TEXT,transactionId TEXT,isUploaded INTEGER NOT NULL DEFAULT 0)")*/
